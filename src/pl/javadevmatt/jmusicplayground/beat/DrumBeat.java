...
public abstract class DrumBeat implements JMC {
	 ...
	 * Subclasses should add KICK_NOTE and REST notes in their implementations
	 * to create the desired beat.
	 */
	protected abstract void composeKicks(final Phrase kicks);

	/**
	 * Used by subclasses to specify the snare portion of the drum beat.
	 * Subclasses should add SNARE_NOTE and REST notes in their implementations
	 * to create the desired beat.
	 */
	 ...
	 * Subclasses should add HAT_NOTE and REST notes in their implementations to
